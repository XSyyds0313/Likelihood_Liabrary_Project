...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.encoder = Encoder(
            [
                EncoderLayer(AutoCorrelationLayer(DSAutoCorrelation(False,
                                                                    configs.factor,
        ...
        self.decoder = Decoder(
            [
                DecoderLayer(AutoCorrelationLayer(DSAutoCorrelation(True,
                                                                    configs.factor,
                                                                    attention_dropout=configs.dropout,
                                                                    output_attention=False),
                                                  configs.d_model,
                                                  configs.n_heads),
                             AutoCorrelationLayer(DSAutoCorrelation(False,
                                                                    configs.factor,
                                                                    attention_dropout=configs.dropout,
                                                                    output_attention=False),
                                                  configs.d_model,
